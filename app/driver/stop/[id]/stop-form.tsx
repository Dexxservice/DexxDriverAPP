  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3 mt-4">
      <div className="grid grid-cols-3 gap-2">
        <input className="border p-2" type="number" placeholder="Länge (cm)" value={L || ""} onChange={e => setL(parseInt(e.target.value || "0"))} />
        <input className="border p-2" type="number" placeholder="Breite (cm)" value={W || ""} onChange={e => setW(parseInt(e.target.value || "0"))} />
        <input className="border p-2" type="number" placeholder="Höhe (cm)" value={H || ""} onChange={e => setH(parseInt(e.target.value || "0"))} />
      </div>

      <input className="border p-2 w-full" type="number" step="0.1" placeholder="Gewicht (kg, optional)" value={weight ?? ""} onChange={e => setWeight(e.target.value ? parseFloat(e.target.value) : undefined)} />
      ...
      <input className="border p-2 w-full" placeholder="Empfänger Name" value={recipient} onChange={e => setRecipient(e.target.value)} />
